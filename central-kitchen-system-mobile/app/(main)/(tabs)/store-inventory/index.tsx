...
export default function StoreInventoryListScreen() {
    ...
    const handleViewBatches = (productId: string) => {
        router.push({
            pathname: "/(main)/(tabs)/store-inventory/[productId]",
            params: { productId },
        });
    };
                    ...
                    {filteredItems.map((item) => (
                        ...
                        >
                            ...
                            <Pressable
                                ...
                                onPress={() => handleViewBatches(item.productId)}
                            >
                                <Text style={styles.detailButtonText}>Xem chi tiết lô hàng</Text>
                            </Pressable>
                        </View>
                    ))}
                </View>
