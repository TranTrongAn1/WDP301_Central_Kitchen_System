...
const PAGE_NAME: Record<string, { name: string; title: string }> = {
  ...
  "/admin/ingredient-requests": { name: "Phiếu xin mua", title: "Phiếu xin mua nguyên liệu" },
  ...
  "/coordinator/shipments": { name: "Đơn giao", title: "Lập lịch & theo dõi chuyến giao hàng" },
  "/coordinator/shipments/:id": { name: "Đơn giao chi tiết", title: "Chi tiết chuyến giao hàng" },
  "/coordinator/production": { name: "Kế hoạch sản xuất", title: "Lập lịch và quản lý tiến độ sản xuất" },
  ...
  "/kitchen/ingredient-requests": { name: "Phiếu xin mua", title: "Phiếu xin mua nguyên liệu" },
